                ...
                <div className="w-[80%] flex border-2 border-yellow-600 rounded">
                    <div className="flex p-8 sm:flex-col">
                        <div className="flex flex-col p-2">
                            ...
                            <p className="m-2">Desde el exterior:(11-11) 2222-2222 o 3333-3333</p>
                            <p className="m-2">De lunes a viernes de 8:00 a 20:00</p>
                        </div>
                        <div className="flex flex-col p-2">
                            <h3 className="font-bold">MESA DE AYUDA DE BANCA ITBANK INTERNET 0810-111-0111</h3>
                            <p className="mt-2 mr-2 ml-2">Individuos: opción 1</p>
                            <p className="mb-2 mr-2 ml-2">Empresas: opción 2</p>
                            <p className="m-2">De lunes a viernes de 8:00 a 22:00. </p>
                            <p className="m-2">Sábados, domingos y feriados de 08:00 a 20:00</p>
                        </div>
                        <div className="flex flex-col p-2">
                            <h3 className="font-bold">CUENTA ITBANK INDIVIDUOS 0810-444-4444</h3>
                            <p className="m-2">De lunes a domingo de 8:00 a 22:00</p>
                            <p className="m-2">Desde el exterior:(54-11) 5555-5555 o 6666-6666</p>
                        </div>
                    </div>
                </div>
            </div>
